...
function openYoutubePopup(videoId, playlistId) {
    var youtube_tv = document.getElementById('youtube_tv');
    youtube_tv.src = "https://www.youtube.com/embed/" + videoId + "?list=" + playlistId;
    youtube_tv.parentElement.style = 'display: flex';
}