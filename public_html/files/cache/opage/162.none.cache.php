<?php if(!defined("__XE__"))exit;?><div class="contents-wrap greeting">
    ...
    <div class="map-info">
            <div class="info-list pd-t-20">
                <div class="mapicon_box"><img src="/layouts/enm/pages/../img/sub/mapicon_1.png" alt=""></div>
                <div class="maptxt_box">
                    ...
                    <div class="kakaomap_box">
                        ...
                        <div class="kakaolink">
                            <a href="https://kko.to/iYWNfiTXSA" target="_blank"><img class="kakaomap_icon" src="/layouts/enm/pages/../img/sub/kakaomap_icon.png" alt=""></a>
                        </div>
                    </div>                    
                </div>
            </div>
            <div class="info-list">
                <div class="mapicon_box"><img src="/layouts/enm/pages/../img/sub/mapicon_2.png" alt=""></div>
                <div class="maptxt_box">
            ...
            <div class="info-list">
                <div class="mapicon_box"><img src="/layouts/enm/pages/../img/sub/mapicon_3.png" alt=""></div>
                <div class="maptxt_box">
