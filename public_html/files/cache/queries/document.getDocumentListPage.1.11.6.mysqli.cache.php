...
${'list_order35_argument'} = new ConditionArgument('list_order', $args->list_order, 'less');
${'list_order35_argument'}->checkFilter('number');
${'list_order35_argument'}->createConditionValue();
if(!${'list_order35_argument'}->isValid()) return ${'list_order35_argument'}->getErrorMessage();
} else
${'list_order35_argument'} = NULL;if(${'list_order35_argument'} !== null) ${'list_order35_argument'}->setColumnType('number');
if(isset($args->rev_list_order)) {
${'rev_list_order36_argument'} = new ConditionArgument('rev_list_order', $args->rev_list_order, 'more');
${'rev_list_order36_argument'}->checkFilter('number');
${'rev_list_order36_argument'}->createConditionValue();
if(!${'rev_list_order36_argument'}->isValid()) return ${'rev_list_order36_argument'}->getErrorMessage();
} else
${'rev_list_order36_argument'} = NULL;if(${'rev_list_order36_argument'} !== null) ${'rev_list_order36_argument'}->setColumnType('number');
if(isset($args->update_order)) {
${'update_order37_argument'} = new ConditionArgument('update_order', $args->update_order, 'less');
${'update_order37_argument'}->checkFilter('number');
${'update_order37_argument'}->createConditionValue();
...
${'rev_update_order38_argument'} = new ConditionArgument('rev_update_order', $args->rev_update_order, 'more');
${'rev_update_order38_argument'}->checkFilter('number');
${'rev_update_order38_argument'}->createConditionValue();
if(!${'rev_update_order38_argument'}->isValid()) return ${'rev_update_order38_argument'}->getErrorMessage();
} else
${'rev_update_order38_argument'} = NULL;if(${'rev_update_order38_argument'} !== null) ${'rev_update_order38_argument'}->setColumnType('number');
if(isset($args->rev_regdate)) {
${'rev_regdate39_argument'} = new ConditionArgument('rev_regdate', $args->rev_regdate, 'less');
${'rev_regdate39_argument'}->checkFilter('number');
${'rev_regdate39_argument'}->createConditionValue();
if(!${'rev_regdate39_argument'}->isValid()) return ${'rev_regdate39_argument'}->getErrorMessage();
} else
${'rev_regdate39_argument'} = NULL;if(${'rev_regdate39_argument'} !== null) ${'rev_regdate39_argument'}->setColumnType('date');
if(isset($args->regdate)) {
${'regdate40_argument'} = new ConditionArgument('regdate', $args->regdate, 'more');
${'regdate40_argument'}->checkFilter('number');
...
,new ConditionGroup(array(
new ConditionWithArgument('`list_order`',$list_order35_argument,"less", 'and')
,new ConditionWithArgument('`list_order`',$rev_list_order36_argument,"more", 'and')
,new ConditionWithArgument('`update_order`',$update_order37_argument,"less", 'and')
,new ConditionWithArgument('`update_order`',$rev_update_order38_argument,"more", 'and')
,new ConditionWithArgument('`regdate`',$rev_regdate39_argument,"less", 'and')
,new ConditionWithArgument('`regdate`',$regdate40_argument,"more", 'and')),'and')
));
