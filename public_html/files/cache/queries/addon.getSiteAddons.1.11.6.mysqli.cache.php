...
${'list_order18_argument'} = new Argument('list_order', $args->{'list_order'});
${'list_order18_argument'}->ensureDefaultValue('addon');
if(!${'list_order18_argument'}->isValid()) return ${'list_order18_argument'}->getErrorMessage();
...
new OrderByColumn(${'list_order18_argument'}, "asc")
));
$query->setLimit();
return $query; ?>