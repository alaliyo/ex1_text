<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/board/skins/KSO_v1/css/board.css--><?php $__tmp=array('modules/board/skins/KSO_v1/css/board.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO_v1/css/font-awesome.min.css--><?php $__tmp=array('modules/board/skins/KSO_v1/css/font-awesome.min.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO_v1/js/board.js--><?php $__tmp=array('modules/board/skins/KSO_v1/js/board.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO_v1/js/masonry.pkgd.min.js--><?php $__tmp=array('modules/board/skins/KSO_v1/js/masonry.pkgd.min.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO_v1/js/jquery.datetimepicker.full.min.js--><?php $__tmp=array('modules/board/skins/KSO_v1/js/jquery.datetimepicker.full.min.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO_v1/css/jquery.datetimepicker.css--><?php $__tmp=array('modules/board/skins/KSO_v1/css/jquery.datetimepicker.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
