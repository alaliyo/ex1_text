...
<?php $__Context->_idx=0 ?>
    ...
    <li class="mainAlbumList" <?php if($__Context->_idx>0 && $__Context->_idx % $__Context->widget_info->cols_list_count==0){ ?> class="clearLeft"<?php } ?> style="<?php if($__Context->_idx >= $__Context->widget_info->list_count){ ?>display:none;<?php } ?>width:<?php echo $__Context->widget_info->thumbnail_width ?>px;">
