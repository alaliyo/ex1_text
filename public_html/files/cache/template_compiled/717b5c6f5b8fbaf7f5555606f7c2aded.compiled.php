...
<div class="view-doc paddingb20 rd wow fadeIn" style="animation-delay:0.5s">
	<div class="cont-title">
		<div class="view_time">
			<div class="custom_day"><?php echo $__Context->oDocument->getRegdate('d') ?></div>
			<div class="custom_ym"><?php echo $__Context->oDocument->getRegdate('Y.m') ?></div>
		</div>
...
echo $__Context->aa_count ?>
	...
	<?php if($__Context->oDocument->hasUploadedFiles()){ ?><ul class="fa-ul nocolor collapse" id="documentfile">
			...
			<?php }else{ ?>
				<?php if($__Context->module_info->display_videoplaydoc=='Y'){ ?>
					...
					<?php 	$__Context->extras	= $__Context->val->getValueHTML(); ?>
						...
						<!--#Meta:modules/board/skins/KSO_application_form_02/js/jwplayer.js--><?php $__tmp=array('modules/board/skins/KSO_application_form_02/js/jwplayer.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
$__Context->tag = $__Context->tag_list[$__Context->i];  ?> <a href="<?php echo getUrl('search_target','tag','search_keyword',$__Context->tag,'document_srl','') ?>" rel="tag" class="label label-default"><?php echo htmlspecialchars($__Context->tag) ?></a><?php } ?>
	...
	<?php if($__Context->oDocument->allowTrackback()){ ?>
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/KSO_application_form_02','trackback.html') ?>
	<?php } ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/KSO_application_form_02','_comment_write.html');
} ?>
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/KSO_application_form_02','comment.html') ?>	
