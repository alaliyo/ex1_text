			...
			<?php }else{ ?>
				<?php if($__Context->module_info->display_videoplaydoc=='Y'){ ?>
					...
					<?php 	$__Context->extras	= $__Context->val->getValueHTML(); ?>
						...
						<!--#Meta:modules/board/skins/KSO/js/jwplayer.js--><?php $__tmp=array('modules/board/skins/KSO/js/jwplayer.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
$__Context->tag = $__Context->tag_list[$__Context->i];  ?> <a href="<?php echo getUrl('search_target','tag','search_keyword',$__Context->tag,'document_srl','') ?>" rel="tag" class="label label-default"><?php echo htmlspecialchars($__Context->tag) ?></a><?php } ?>
	...
	<?php if($__Context->oDocument->allowTrackback()){ ?>
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/KSO','trackback.html') ?>
	<?php } ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/KSO','_comment_write.html');
} ?>
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/KSO','comment.html') ?>	
