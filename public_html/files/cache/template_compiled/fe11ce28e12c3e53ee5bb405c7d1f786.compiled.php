<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/board/skins/KSO/css/board.css--><?php $__tmp=array('modules/board/skins/KSO/css/board.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO/css/font-awesome.min.css--><?php $__tmp=array('modules/board/skins/KSO/css/font-awesome.min.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO/js/board.js--><?php $__tmp=array('modules/board/skins/KSO/js/board.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/KSO/js/masonry.pkgd.min.js--><?php $__tmp=array('modules/board/skins/KSO/js/masonry.pkgd.min.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
